...
@TableGenerator(
        name = "member_sequence_table_generator",
...
public class Member {
    ...
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "member_sequence_table_generator")
    ...
    @Column(name = "phone", columnDefinition = "varchar(200) default '010-8765-4321'")
