...
public class MenuService {
    ...
    private final MenuRepository menuRepository;        // 쿼리를 날려주는 역할을 하는 계층
    ...
    public List<MenuDTO> findMenuList() {
        ...
        // Menu-> MenuDTO (entity -> DTO)
    }

    /* 설명. 3. findAll 예제 (페이징 처리 후) */
    public Page<MenuDTO> findMenuList(Pageable pageable) {

        /* 설명.
         *  1. 넘어온 pageable 에 담긴 페이지 번호를 인덱스 개념으로 바꿔서 인지시킴
         *  2. 한 페이지에 뿌려질 데이터 크기
         *  3. 정렬 기준
        * */
